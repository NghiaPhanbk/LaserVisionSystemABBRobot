...
from App_Lib.App import save_coefficients
...
def ex_monoCalibrate():
    ...
    save_camera_params_path = camera_external_params
    checker_path = Checkerboard_calib_eye_to_hand_path
